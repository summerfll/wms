...
#include "../../../../UWB_QT/uwb_qt/Deca/views/storage_delete.h"
...
QT_MOC_LITERAL(3, 40, 21) // "on_pushButton_clicked"
    ...
    "storage_delete\0on_pushButton_2_clicked\0"
...
void storage_delete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        storage_delete *_t = static_cast<storage_delete *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject storage_delete::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_storage_delete.data,
      qt_meta_data_storage_delete,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *storage_delete::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_storage_delete.stringdata0))
        return static_cast<void*>(const_cast< storage_delete*>(this));
